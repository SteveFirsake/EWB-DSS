var WAPOR_Actual = ee.ImageCollection("FAO/WAPOR/2/L1_AETI_D"),
    ...
    MCD64A1_006 = ee.ImageCollection("MODIS/006/MCD64A1"),
    MOD14A1_006 = ee.ImageCollection("MODIS/006/MOD14A1"),
    MYD14A1_006 = ee.ImageCollection("MODIS/006/MYD14A1"),
    GOES_16_FDCF = ee.ImageCollection("NOAA/GOES/16/FDCF"),
    GOES_17_FDCF = ee.ImageCollection("NOAA/GOES/17/FDCF"),
    Sentinel_2_VI = ee.ImageCollection("COPERNICUS/S2_SR"),
    ...
    NASA_USDA = ee.ImageCollection("NASA_USDA/HSL/SMAP10KM_soil_moisture"),
    MOD11A1_006 = ee.ImageCollection("MODIS/006/MOD11A1"),
    MYD11A1_006 = ee.ImageCollection("MODIS/006/MYD11A1"),
    MCD15A3H_006 = ee.ImageCollection("MODIS/006/MCD15A3H"),
    MOD13Q1_006 = ee.ImageCollection("MODIS/006/MOD13Q1"),
    MYD13Q1_006 = ee.ImageCollection("MODIS/006/MYD13Q1"),
    MYD15A2H_006 = ee.ImageCollection("MODIS/006/MYD15A2H"),
    ...
    MYD17A2H_006 = ee.ImageCollection("MODIS/006/MYD17A2H"),
    ...
    MOD_T_NDSI = ee.ImageCollection("MODIS/006/MOD10A1"),
    MOD_A_NDSI = ee.ImageCollection("MODIS/006/MYD10A1"),
    ...
    MOD_A_SNOW = ee.ImageCollection("MODIS/006/MYD10A1"),
    MOD_T_SNOW = ee.ImageCollection("MODIS/006/MOD10A1"),
    ...
    MOD11A1_0062 = ee.ImageCollection("MODIS/061/MOD11A1"),
    MYD11A1_0062 = ee.ImageCollection("MODIS/061/MYD11A1"),
    MCD15A3H_0062 = ee.ImageCollection("MODIS/061/MCD15A3H"),
    MOD13Q1_0062 = ee.ImageCollection("MODIS/061/MOD13Q1"),
    MYD13Q1_0062 = ee.ImageCollection("MODIS/061/MYD13Q1"),
    MYD15A2H_0062 = ee.ImageCollection("MODIS/061/MYD15A2H"),
    VIIRS_VI = ee.ImageCollection("NOAA/VIIRS/001/VNP09GA"),
    kenya_gadm0 = ee.FeatureCollection("users/firsake/Kenya_GADM/KEN_GADM_0");
 
//all themes//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var dataset_themes = ['SELECT THEME','Air Quality','Evapo-Transpiration','Fire','Precipitation', 'Soil Moisture','Temperature', 'Vegetation', 'Weather'];
var garbage_collector_miniLayers = [];

//dataset per theme///////////////////////////////////////////////////////////////////////////////////////////////////////////

var image_collection, lyr_image, selected_data;
...
var dataset_map =  {
                      "MOD16A2_006":MOD16A2_006,
                      "WAPOR_Actual" : WAPOR_Actual,
                      "WAPOR_Daily" : WAPOR_Daily,
                      "GOES_16_FDCF" : GOES_16_FDCF,
                      "GOES_17_FDCF" : GOES_17_FDCF,
                      "MOD14A1_006" : MOD14A1_006,
                      "MYD14A1_006" : MYD14A1_006,
                      "CHIRPS_Daily" : CHIRPS_Daily,
                      "GSMaP" : GSMaP,
                      //"PERSIANN_CDR" : PERSIANN_CDR,
                      "NASA_USDA" : NASA_USDA,
                      "MOD11A1_006" : MOD11A1_006,
                      "MYD11A1_006" : MYD11A1_006,
                      "MCD15A3H_006" : MCD15A3H_006,
                      "MOD13Q1_006" : MOD13Q1_006,
                      "MYD13Q1_006" : MYD13Q1_006,
                      "MYD15A2H_006" : MYD15A2H_006,
                      "Sentinel_2_VI" : Sentinel_2_VI,
                      "VNP13A1": VNP13A1,
                      //"LGPP" : LGPP,
                      //"MGPP" : MGPP,
                      "MYD17A2H_006" : MYD17A2H_006,
                      "MOD17A2H_006" : MOD17A2H_006,
                      "S5_CO" : S5_CO,
                      "S5_CH4" : S5_CH4,
                      "S5_SO2" : S5_SO2,
                      "S5_NO2" : S5_NO2,
...
var dataset_multiplier =  { 
                            ...
                            "MOD11A1_006" : 0.02,
                            "MYD11A1_006" : 0.02,
                            "MCD15A3H_006" : [0.01, 0.1],
                            "MOD13Q1_006" : 0.0001,
                            "MYD13Q1_006" : 0.0001,
                            "MYD15A2H_006" : [0.01, 0.1],
                            "Sentinel_2_VI" : 1,
                            "VNP13A1": 0.0001,
                            //"LGPP" : 0.0001,
                            //"MGPP" : 0.0001,
...
var dataset_title =  {
                      "MOD16A2_006": "MOD16A2.006: Terra Net Evapotranspiration 8-Day Global 500m",
                      ...
                      "MOD14A1_006" : "MOD14A1.006: Terra Thermal Anomalies & Fire Daily Global 1km",
                      "MYD14A1_006" : "MYD14A1.006: Aqua Thermal Anomalies & Fire Daily Global 1km",
                      ...
                      "NASA_USDA" : "NASA-USDA Enhanced SMAP Global Soil Moisture Data",
                      "MOD11A1_006" : "MOD11A1.061 Terra Land Surface Temperature and Emissivity Daily Global 1km",
                      "MYD11A1_006" : "MYD11A1.061 Aqua Land Surface Temperature and Emissivity Daily Global 1km",
                      "MCD15A3H_006" : "MCD15A3H.061 MODIS Leaf Area Index/FPAR 4-Day Global 500m" ,
                      "MOD13Q1_006" : "MOD13Q1.061 Terra Vegetation Indices 16-Day Global 250m",
                      "MYD13Q1_006" : "MYD13Q1.061 Aqua Vegetation Indices 16-Day Global 250m" ,
                      "MYD15A2H_006" : "MYD15A2H.061: Aqua Leaf Area Index/FPAR 8-Day Global 500m",
                      ...
                      "MYD17A2H_006" : "MYD17A2H.006: Aqua Gross Primary Productivity 8-Day Global 500m",
                      "MOD17A2H_006" : "MOD17A2H.006: Terra Gross Primary Productivity 8-Day Global 500m",
                      ...
                      "MOD_A_SNOW" : "MYD10A1.006 Aqua Snow Cover Daily Global 500m",
                      "MOD_T_SNOW" : "MOD10A1.006 Terra Snow Cover Daily Global 500m",
...
var dataset_url =  {
                      "MOD16A2_006":"https://lpdaac.usgs.gov/products/mod16a2v006/",
                      ...
                      "MOD14A1_006" : "https://lpdaac.usgs.gov/products/mod14a1v006/",
                      "MYD14A1_006" : "https://lpdaac.usgs.gov/products/mod14a1v006/",
                      ...
                      "NASA_USDA" : "https://gimms.gsfc.nasa.gov/SMOS/SMAP/",
                      "MOD11A1_006" : "https://lpdaac.usgs.gov/products/mod11a1v061/",
                      "MYD11A1_006" : "https://lpdaac.usgs.gov/products/myd11a1v061/",
                      "MCD15A3H_006" : "https://lpdaac.usgs.gov/products/mcd15a3hv061/",
                      "MOD13Q1_006" : "https://lpdaac.usgs.gov/products/mod13q1v061/",
                      "MYD13Q1_006" : "https://lpdaac.usgs.gov/products/myd13q1v061/",
                      "MYD15A2H_006" : "https://lpdaac.usgs.gov/products/myd15a2hv061/",
                      ...
                      "MYD17A2H_006" : "https://lpdaac.usgs.gov/products/myd17a2hv006/",
                      "MOD17A2H_006" : "https://lpdaac.usgs.gov/products/mod17a2hv006/",
...
var dataset_bands = [
                      ...
                      [ ['SELECT BAND', 'Fpar', 'Lai'],
                        ...
                        ['SELECT BAND', 'NDVI'],
                        ['SELECT BAND', 'KBDI'],
                        ['SELECT BAND', 'MODIS_VCI'],
                        ['SELECT BAND', 'NDVI', 'EVI'],
                        ['SELECT BAND', 'VIIRS_VCI'],
                        ['SELECT BAND', 'NDVI'],
                      ],
...
var statistics = ['SELECT STATISTIC', 'Mean', 'Max', 'Min', 'Median', 'Standard Deviation', 'Variance', 'Sum', 'Combined'];
...
var palette_def = ['Low','Medium','High'];
...
var palettes = [palette_air, palette_et, palette_fire, palette_ppt, palette_sm, palette_temp, palette_veg, palette_wt];
var vizParams = [vizParams_air, vizParams_et, vizParams_fire, vizParams_ppt, vizParams_sm, vizParams_temp, vizParams_veg, vizParams_wt];
...
var lyr_y = ee.Image().paint(kenya_gadm0, 0, 4.0);
var countryLayer = ui.Map.Layer(lyr_y, {palette:['007777']}, 'Country');
...
var legends = [legend_air, legend_et, legend_fire, legend_ppt, legend_sm, legend_temp, legend_veg, legend_wt];
...
var intro = ui.Panel([
  ui.Label({
    value: 'Environmental Web-Based Decision Support System',
    style: {fontSize: '20px', fontWeight: 'bold', color: '#10968D',  textAlign: 'center',stretch: 'horizontal', margin:'10px 0px 0px 0px'}
  }),
  ui.Label(
    {
    value: 'EWB-DSS Kenya',
    style: {fontSize: '15px', fontWeight: 'bold', color: '#000000', textAlign: 'center',stretch: 'horizontal', margin:'10px 0px 0px 0px'}
    }
  )
]);
panel.add(intro);
...
var lblCreator = ui.Label(
  {
    value: 'By: Steve Omondi Otieno (G221-01-2588/2022)',
    style: {fontSize: '12px', fontWeight: 'bold', color: '#10968D',  textAlign: 'center', stretch: 'horizontal', padding:'50px 0px 0px 0px'}
  }
);
  ...
  if (selected_theme !== null && selected_theme !== 'SELECT THEME' && selected_data !== null && selected_data !== 'SELECT DATA'){
    ...
    switch(selected_theme) {
            ...
            case 'Fire':
              ...
              } else if(selected_data == 'MOD14A1_006'){
                selectBand.items().reset(dataset_bands[2][2]);
              } else if(selected_data == 'MYD14A1_006'){
            ...
            case 'Temperature':
              ...
              if(selected_data == 'MOD11A1_006'){
                selectBand.items().reset(dataset_bands[5][0]);
              } else if(selected_data == 'MYD11A1_006'){
            ...
            case 'Vegetation':
              ...
              if(selected_data == 'MCD15A3H_006'){
                selectBand.items().reset(dataset_bands[6][0]);
              } else if(selected_data == 'MOD13Q1_006'){
                selectBand.items().reset(dataset_bands[6][1]);
              } else if(selected_data == 'MYD13Q1_006'){
                selectBand.items().reset(dataset_bands[6][2]);
              } else if(selected_data == 'MYD15A2H_006'){
              ...
              } else if(selected_data == 'MYD17A2H_006'){
                selectBand.items().reset(dataset_bands[6][6]);
              } else if(selected_data == 'MOD17A2H_006'){
                selectBand.items().reset(dataset_bands[6][7]);
...
function displayImage(){
  ...
  var selected_image = ee.Image(image_collection.filter(ee.Filter.eq('date', selected_date)).first());
...
function Rescale(image){
  ...
  if(selected_data != 'MCD15A3H_006' && selected_data != 'MYD15A2H_006'){
...
function Redraw(){
  ...
  if(selectBoundaryType.getValue() == "DEFINE REGION"){
    ...
    if(selectBoundaryType.getValue() == "Administrative Boundary" && region_exists === false){
      alert("Please select a Region");
      return null;
    }else{
      selected_roi_name = selectRegionName.getValue();
    }
  ...
  if (selected_data == "Sentinel_2_VI"){
    ...
    image_collection = modis_vci_IC.getVCIcollection(selected_roi_geom).filterDate(selected_start_date, selected_end_date);
    
  }else if(selected_data == "VIIRS_VCI"){
    image_collection = viirs_vci_IC.getVCIcollection(selected_roi_geom).filterDate(selected_start_date, selected_end_date);
      ...
      image_collection = ee.ImageCollection(imagesListeVIIRS).filterDate(selected_start_date, selected_end_date)
                                                             .map(NormalizeEVIIRS);
                   
  }else if(selected_data == "MOD14A1_006" || selected_data == "MYD14A1_006" ){
    image_collection = selected_imagecol.filterDate(selected_start_date, selected_end_date)
                                    .filterBounds(selected_roi_geom)
                                    .map(maskQA_MOD_fire)
                                    .map(ClipperBand)
  ...
  }else if(selected_data == "GOES_16_FDCF" || selected_data == "GOES_17_FDCF" ){
    image_collection = selected_imagecol.filterDate(selected_start_date, selected_end_date)
                                    .filterBounds(selected_roi_geom)
  ...
  //dates selection
  var dates = image_collection.reduceColumns(ee.Reducer.toList(), ['date']).get('list');
  var dates_list = dates.getInfo();
  ...
  if(dates_list.length > 0){
    ...
    if(selected_data != "Sentinel_2_VI"){
      ...
      // Create Feature Collection of statistic value
      ft_col = image_collection.map(function(img) {
        var date = img.get('system:time_start');
        var stat_value = img.reduceRegion({
            reducer: selected_statistic_reducer,
